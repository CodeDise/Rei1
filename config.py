...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8563304709:AAFt4GhJSlMAL31IH2cvi2hdE678zDVwwDY")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003383167475")) #Your db channel Id
OWNER = os.environ.get("OWNER", "sewxiy") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "8354980965")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://odb.net/?retryWrites=true&w=majority&appName=Animenohara")
DB_NAME = os.environ.get("DATABASE_NAME", "Cluooo")
#--------------------------------------------
FSUB_LINK_EXPIRY = int(os.getenv("FSUB_LINK_EXPIRY", "20"))  # 0 means no expiry
BAN_SUPPORT = os.environ.get("BAN_SUPPORT", "https://t.me/DUSELLER")
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ᴘᴏᴡᴇʀ ʙʏ <a href=https://t.me/nohara_network>ɴᴏʜᴀʀᴀ ɴᴇᴛᴡᴏʀᴋ</a></b>") #set your Custom Caption here, Keep None for Disable Custom Caption
